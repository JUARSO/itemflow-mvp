...
export const MOCK_RECIPES: Recipe[] = [
  {
    ...
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 1.5, unit: 'kg' },
      { supplyId: 's-sal', supplyName: 'Sal de mesa', qty: 0.03, unit: 'kg' },
      { supplyId: 's-levadura', supplyName: 'Levadura fresca', qty: 0.02, unit: 'kg' },
    ],
  },
  {
    id: 'p-marraqueta', productId: 'p-marraqueta', productName: 'Marraqueta', yieldQty: 20,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 2.0, unit: 'kg' },
      { supplyId: 's-sal', supplyName: 'Sal de mesa', qty: 0.04, unit: 'kg' },
      { supplyId: 's-levadura', supplyName: 'Levadura fresca', qty: 0.025, unit: 'kg' },
    ],
  },
  {
    id: 'p-hallulla', productId: 'p-hallulla', productName: 'Hallulla', yieldQty: 20,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 1.8, unit: 'kg' },
      { supplyId: 's-sal', supplyName: 'Sal de mesa', qty: 0.035, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.18, unit: 'kg' },
    ],
  },
  {
    id: 'p-croissant', productId: 'p-croissant', productName: 'Croissant mantequilla', yieldQty: 12,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 0.6, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.3, unit: 'kg' },
      { supplyId: 's-leche', supplyName: 'Leche entera', qty: 0.25, unit: 'L' },
      { supplyId: 's-levadura', supplyName: 'Levadura fresca', qty: 0.015, unit: 'kg' },
      { supplyId: 's-azucar', supplyName: 'Azúcar granulada', qty: 0.06, unit: 'kg' },
    ],
  },
  {
    id: 'p-empanada', productId: 'p-empanada', productName: 'Empanada queso', yieldQty: 10,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 0.5, unit: 'kg' },
      { supplyId: 's-queso', supplyName: 'Queso crema', qty: 0.35, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.1, unit: 'kg' },
      { supplyId: 's-sal', supplyName: 'Sal de mesa', qty: 0.01, unit: 'kg' },
    ],
  },
  {
    id: 'p-brownie', productId: 'p-brownie', productName: 'Brownie chocolate', yieldQty: 16,
    items: [
      { supplyId: 's-choco', supplyName: 'Chocolate cobertura', qty: 0.25, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.2, unit: 'kg' },
      { supplyId: 's-azucar', supplyName: 'Azúcar granulada', qty: 0.3, unit: 'kg' },
      { supplyId: 's-huevos', supplyName: 'Huevos', qty: 4, unit: 'unidad' },
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 0.15, unit: 'kg' },
      { supplyId: 's-cacao', supplyName: 'Cacao en polvo', qty: 0.05, unit: 'kg' },
    ],
  },
  {
    id: 'p-pie', productId: 'p-pie', productName: 'Pie de limón', yieldQty: 1,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 0.25, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.15, unit: 'kg' },
      { supplyId: 's-azucar', supplyName: 'Azúcar granulada', qty: 0.2, unit: 'kg' },
      { supplyId: 's-huevos', supplyName: 'Huevos', qty: 6, unit: 'unidad' },
      { supplyId: 's-leche', supplyName: 'Leche entera', qty: 0.4, unit: 'L' },
    ],
  },
  {
    id: 'p-galleta', productId: 'p-galleta', productName: 'Galleta avena pasas', yieldQty: 24,
    items: [
      { supplyId: 's-harina', supplyName: 'Harina de trigo', qty: 0.3, unit: 'kg' },
      { supplyId: 's-mantequilla', supplyName: 'Mantequilla sin sal', qty: 0.15, unit: 'kg' },
      { supplyId: 's-azucar', supplyName: 'Azúcar granulada', qty: 0.18, unit: 'kg' },
      { supplyId: 's-huevos', supplyName: 'Huevos', qty: 2, unit: 'unidad' },
      { supplyId: 's-canela', supplyName: 'Canela molida', qty: 0.005, unit: 'kg' },
    ],
  },
];
